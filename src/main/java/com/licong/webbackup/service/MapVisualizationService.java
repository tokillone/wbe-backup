...
public interface MapVisualizationService {
    ...
    MapStatsResponse getStats(String category, String subcategory, String biomarkerKey, String year, String levels);

    MapDetailResponse getDetail(String level, String geoKey, String category, String subcategory,
